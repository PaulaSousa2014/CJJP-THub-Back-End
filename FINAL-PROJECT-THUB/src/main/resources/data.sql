...
INSERT INTO users (NAME,username, password, email, steam_username, position, office) VALUES 
	('JAVIER PÉREZ','javier334', '$2a$10$mR4MU5esBbUd6JWuwWKTA.tRy.jo4d4XRkgnamcOJfw5pJ8Ao/RDS', 'javi@javi.com', 'javisteam', 1, 1),
	('CAMILA GARCIA','camila324', '$2a$10$mR4MU5esBbUd6JWuwWKTA.tRy.jo4d4XRkgnamcOJfw5pJ8Ao/RDS', 'cami@cami.com', 'camisteam', 1, 1),
	('JOSEP MARIA PALLÀS','josep445', '$2a$10$mR4MU5esBbUd6JWuwWKTA.tRy.jo4d4XRkgnamcOJfw5pJ8Ao/RDS', 'jose@jose.com', 'josesteam', 2, 2),
	('PAULA SOUSA','paula334', '$2a$10$mR4MU5esBbUd6JWuwWKTA.tRy.jo4d4XRkgnamcOJfw5pJ8Ao/RDS', 'pauli@pauli.com', 'paulisteam', 2, 2);
